...
insert into `book`(site_code, user_code, merchant_uid, book_member, book_checkin, book_checkout, book_price, book_car_number) values(1,1,'4',2,'2023-02-02','2023-02-05',45000,'13나1234');
